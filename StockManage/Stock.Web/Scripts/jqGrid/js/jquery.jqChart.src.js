...
*/
 (function() {
    ...
    function Ga(a, b, c) {
        var d,
        e;
        if (Sb(b)) if (K(c)) a.setAttribute(b, c);
        else {
    ...
    function Nd(a, b) {
        function c(p) {
            ...
            function N(k, n) {
                ...
                if (!n) {
                    n = [1, 2, 2.5, 5, 10];
                    if (o.allowDecimals === false || ca) if (Fb === 1) n = [1, 2, 5, 10];
            ...
            function da() {
                ...
                if (D) {
                    ...
                    r = 2592E6 / ub;
                    var $ = 31556952E3 / ub,
                    F = [["second", Q, [1, 2, 5, 10, 15, 30]], ["minute", fa, [1, 2, 5, 10, 15, 30]], ["hour", ka, [1, 2, 3, 4, 6, 8, 12]], ["day", E, [1, 2]], ["week", k, [1, 2]], ["month", r, [1, 2, 3, 4, 6]], ["year", $, null]],
                    O = F[6],
                    S = O[1],
                    aa = O[2];
            ...
            function eb() {
                ...
                if (E || Ub) {
                    ...
                    J || u((o.plotLines || []).concat(o.plotBands || []), 
                    function($) {
                ...
                Wb, dc], 
                function($) {
                    for (var F in $) if ($[F].isActive) $[F].isActive = false;
                    else {
                        $[F].destroy();
                        delete $[F]
                    }
                ...
                if (n && n.enabled) {
                    ...
                    ka;
                    n = I.stackTotalGroup;
                    if (!n) I.stackTotalGroup = n = ga.g("stack-labels").attr({
                        visibility: Ab,
                        zIndex: 6
                    }).translate(X, ea).add();
                    for (fa in s) {
            ...
            q.prototype = {
                addLabel: function() {
                    ...
                    r = Ya && R && Ya.length && !n.step && !n.staggerLines && !n.rotation && Da / Ya.length || !R && Da / 2,
                    J = Ya && K(Ya[k]) ? Ya[k] : k,
                    E = this.label;
                    k = je.call({
                        isFirst: k === Ba[0],
                    ...
                    if (k || Ub) {
                        ...
                        function(fa) {
                            ...
                            if (L === 0 || L === 2 || {
                                1: "left",
                                3: "right"
                            } [L] === J.align) rc = Ia(mb[fa].getLabelSize(), rc)
                        });
                        if ($c) rc += ($c - 1) * 16
                    } else for (Q in mb) {
                        mb[Q].destroy();
        ...
        function e(p) {
            ...
            I = ga.rect(ab, ab, 0, 0, p.borderRadius, N).attr({
                ...
                "stroke-width": N
            }).add(o).shadow(p.shadow),
            ba = ga.text("", eb + ab, ja(Ma.fontSize) + eb + ab, p.useHTML).attr({
                zIndex: 1
            }).css(Ma).add(o);
            o.hide();
            return {
        ...
        function f(p) {
            ...
            bd = function() {
                ...
                } else l.trackerGroup = Ec = ga.g("tracker").attr({
                    zIndex: 9
                }).add()
            };
            bd();
            if (p.enabled) l.tooltip = hc = e(p); (function() {
                oa.onmousedown = function(s) {
                    s = q(s); ! Kb && s.preventDefault && s.preventDefault();
                ...
                var L = function(s) {
                    if (! (s && s.touches && s.touches.length > 1)) {
                        ...
                        ba = !gc(o - X, I - ea);
                        Jb || (Jb = Fd(oa));
                        if (Kb && s.type === "touchstart") if (Ga(s.target, "isTracker")) l.runTrackerClick || s.preventDefault();
        ...
        function Y() {
            ...
            if (!l.seriesGroup) l.seriesGroup = ga.g("series-group").attr({
                zIndex: 3
            }).add();
            u(Ha, 
            function(x) {
        ...
        function U() {
            if (!Lc && db == db.top && ua.readyState !== "complete") ua.attachEvent("onreadystatechange", 
            function() {
        ...
        le = function() {
            ...
            function x(G) {
                ...
                if (!pa) {
                    ...
                    if (La) ha = ga.rect(na = -da - Ma, Ra = -11, da, 12, 2).attr({
                        zIndex: 3
                    }).add(qa);
                    else if (wa && wa.marker && wa.marker.enabled) ha = ga.symbol(G.symbol, na = -da / 2 - Ma, Ra = -4, wa.marker.radius).attr({
                        zIndex: 3
                    }).add(qa);
                    if (ha) {
                        ha.xOff = na + zb % 2 / 2;
        ...
        td = function(p) {
            var q = Xa.lang,
            w = l.pointCount < 100;
            l.toolbar.add("zoom", q.resetZoom, q.resetZoomTitle, $d); ! p || p.resetSelection ? u(Va, 
            function(x) {
        ...
        Gc = function() {
            ...
            if (p.enabled && !p.floating) if (V === "right") K(C) || (Ib = Ia(Ib, $b - w + q + Ea));
            else if (V === "left") K(Sa) || (X = Ia(X, $b + w + q + Lb));
            else if (N === "top") K(y) || (ea = Ia(ea, ac + x + q + Na));
            else if (N === "bottom") K(Z) || 
            (vb = Ia(vb, ac - x + q + gb));
            sc && u(Va, 
            function(da) {
                da.getOffset()
        ...
        vd = function() {
            ...
            V = p + (z.shadow ? 
            8: 0);
            if (p || q) if (wc) wc.animate(wc.crisp(null, null, null, $a - V, cb - V));
            else wc = ga.rect(V / 2, V / 2, $a - V, cb - V, z.borderRadius, p).attr({
                stroke: z.borderColor,
                "stroke-width": p,
                fill: q || jb
            }).add().shadow(z.shadow);
            if (w) if (Kc) Kc.animate(N);
            else Kc = ga.rect(X, ea, Da, Aa, 0).attr({
                fill: w
            }).add().shadow(z.plotShadow);
            if (x) if (Ad) Ad.animate(N);
            else Ad = ga.image(x, X, ea, Da, Aa).add();
            if (z.plotBorderWidth) if (xc) xc.animate(xc.crisp(null, X, ea, Da, Aa));
            else xc = ga.rect(X, ea, Da, Aa, 0, z.plotBorderWidth).attr({
    ...
    var bc = function(a) {
        ...
        c; (function(d) {
            ...
            10)];
            else if (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(d)) b = [ja(c[1], 16), ja(c[2], 16), ja(c[3], 16), 1]
        })(a);
        return {
            get: function(d) {
    ...
    ed.prototype = {
        ...
        buildText: function(a) {
            ...
            if (i) {
                if (!j) j = a.htmlNode = hb("span", null, sa(h, {
                    position: ic,
                    top: 0,
                    left: 0
                }), this.box.parentNode);
            ...
            attr: function(a, b) {
                ...
                if (Sb(a)) {
                    ...
                    if (j && /^(x|y|r|start|end|width|height|innerR)/.test(c)) {
                        ...
                        this[c] = d;
                        if (lc(d)) d += Ua
                    } else if (c === "dashstyle") { (f.getElementsByTagName("stroke")[0] || hb(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid";
                        this.dashstyle = d;
                        m = true
    ...
    sb.prototype = {
        ...
        drawDataLabels: function() {
            if (this.options.dataLabels.enabled) {
                ...
                else g = this.dataLabelsGroup = i.g("data-labels").attr({
        ...
        drawGraph: function() {
            ...
            function(U) {
                ...
                if (T) {
                    ...
                    if (b.stacking && a.type !== "areaspline") for (M = U.length - 1; M >= 0; M--) z.push(U[M].plotX, U[M].yBottom);
            ...
            if (T) {
                ...
                else a.area = a.chart.renderer.path(H).attr({
                    fill: e
                }).add(g)
            }
            if (c) {
    ...
    var hd = yb(sb, {
        ...
        drawTracker: function() {
            ...
            function(m) {
                ...
                if (m.y !== null) if (e) e.attr(d);
                else m.tracker = c[m.shapeType](d).attr({
                    isTracker: f,
                    fill: ce,
                    visibility: a.visible ? Ab: ob,
                    zIndex: g.zIndex || 1
    ...
    ma = yb(sb, {
        ...
        drawPoints: function() {
            ...
            function(i) {
                ...
                if (d) d.animate(h);
                else i.graphic = b.arc(h).attr(sa(i.pointAttr[ib], {
